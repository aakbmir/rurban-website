    ...
    <div className="about-section" id="about">
      ...
      <div className="about-text-content">
        ...
        <p className="about-description">
          Utilizing software, we created an app that allows for greater
          efficiency in ER-related services that better serve the ER and the
          patient. We are constantly expanding our services in a field with
          significant potential.
        </p>
        <h4 className="about-text-title">Your Solutions</h4>
        <Points
          title="Our Mission: Bridging the Healthcare Divide"
        ...
        />
        <Points
          title="Our Vision: Healthcare Equality for All"
